...
define('TEXT_RATHER_COWOA', 'For a faster checkout experience, you can checkout without creating an account. <span style="color:red;">NOTE:</span> You must be logged in to an account in order to redeem and spend online gift certificates you have received.<br />');
