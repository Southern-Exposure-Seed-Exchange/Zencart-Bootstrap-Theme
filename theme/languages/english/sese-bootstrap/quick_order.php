...
define('HEADING_TITLE', 'Quick Ordering by Catalog Number');

define('TEXT_QO_MODEL', '');
define('TEXT_QO_QTY', 'Quantity');
define('TEXT_QO_NAME_MODEL', 'Catalog Number');

define('ERROR_AT_LEAST_ONE_INPUT', 'Please enter a Catalog number and quantity to add to shopping cart.');
define('ERROR_QUANTITY_MUST_BE_INTEGER', 'Quantity must be a numerical integer value.');
define('ERROR_NOT_VALID_MODEL_NUMBER', 'Invalid Catalog number: %s');
define('ERROR_NOT_VALID_MODEL_NUMBER_SUGGEST_ALTERNATES', 'Invalid Catalog number: %s<br />Were you looking for one of the following?');
