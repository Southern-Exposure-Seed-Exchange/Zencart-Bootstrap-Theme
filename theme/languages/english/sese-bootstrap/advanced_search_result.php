...
define('TEXT_SEARCH_HELP', '<p>Keywords may be separated by AND and/or OR statements for greater control of the search results.</p><p>For example, Microsoft AND mouse would generate a result set that contain both words. However, for mouse OR keyboard, the result set returned would contain both or either words.</p><p>Exact matches can be searched for by enclosing keywords in double-quotes.</p><p>For example, "notebook computer" would generate a result set which match the exact string.</p><p>Brackets can be used for further control on the result set.</p><p>For example, Microsoft and (keyboard or mouse or "visual basic").');
