...
define('HEADING_TITLE', 'Order Successful');
...
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', 'Click the Log Off link to ensure that your receipt and purchase information is not visible to the next person using this computer.');
