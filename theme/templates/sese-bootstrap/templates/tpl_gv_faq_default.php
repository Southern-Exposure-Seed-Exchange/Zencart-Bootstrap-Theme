...
<div class='page-header'><h1 id="gvFaqDefaultHeading"><?php echo HEADING_TITLE; ?></h1></div>
...
<p class='clearfix'><?php echo BootstrapUtils::back_link(); ?></p>
...
<div class='form-group'>
  <label for="lookup-gv-redeem"><?php echo TEXT_GV_REDEEM_ID; ?></label>
  <?php echo zen_draw_input_field('gv_no', $_GET['gv_no'], 'size="18" id="lookup-gv-redeem" class="form-control"');?>
</div>
</fieldset>

<p class='clearfix'><button class="pull-right btn btn-primary"><?php echo BUTTON_REDEEM_ALT; ?></button></p>
</form>
