...
<?php echo zen_draw_form('create_account', zen_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'), 'post', 'class="form-horizontal" onsubmit="return check_form(create_account);"') . zen_draw_hidden_field('action', 'process') . zen_draw_hidden_field('email_pref_html', 'email_format'); ?>
...
<div class='clearfix'>
  <p class="pull-right">
    <button class='btn btn-primary' type='submit'><?php echo BUTTON_SUBMIT_ALT; ?></button>
  </p>
</div>
</form>
</div>
